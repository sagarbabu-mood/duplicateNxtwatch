...
const WeEtch = () => (
  <div className="cont1-form1-we">
    <h1 className="head1-form1">WE ETCH PROCESS</h1>
    <div>
      <form>
        <h1 className="head1-form2-we">INOX-1</h1>
        <div className="cont2-form1-we">
          <div className="cont2-inner-we">
            <label className="label1-we">Before ETCH (gm) :</label>
            <input type="text" className="input1-we" />
          </div>
          <div className="after-etch-cont-we">
            <label className="label1-we">After ETCH (gm) :</label>
            <input type="text" className="input2-we" />
          </div>
        </div>
        <div>
          <h1 className="head1-form2-we">INOX-2</h1>
          <div className="batchcont2-form1-we">
            <div className="batchcont2-inner-we">
              <label className="label1-we">Before ETCH (gm) :</label>
              <input type="text" className="input1-we" />
            </div>
            <div className="batchcont2-inner2-we">
              <label className="label1-we">After ETCH (gm) :</label>
              <input type="text" className="input2-we" />
            </div>
          </div>
          <div className="batchbtn-cont-we">
            <button className="batch-button-we">Save</button>
          </div>
        </div>
      </form>
      <hr className="line" />
      <div className="cont-tex">
        <h1 className="head1-form1">INOX-1</h1>
      ...
      <hr className="line" />
      <div className="cont-tex">
        <h1 className="head1-form1">INOX-2</h1>
        <div className="two-row-cont">
          <div>
            <h1 className="head1-form2">Loading</h1>
